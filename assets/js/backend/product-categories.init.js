                        ...
                        <div class="card-body p-4">\
                            <div class="d-flex align-items-center mb-3">\
                                ...
                                <ul class="flex-shrink-0 list-unstyled hstack gap-1 mb-0">\
                                    <li><a href="#!" class="badge badge-soft-info edit-list" data-edit-id="'+ datas[i].id + '">Edit</a></li>\
                                    <li><a href="#delteModal" data-bs-toggle="modal" class="badge badge-soft-danger remove-list" data-remove-id="'+ datas[i].id + '">Delete</a></li>\
                                </ul>\
                            </div>\
