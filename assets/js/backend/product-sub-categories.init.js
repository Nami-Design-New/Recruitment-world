        ...
        columns: [
            ...
            },
            {
                ...
                data: (function (row) {
                    ...
                    <li>\
                        <a href="#" class="badge badge-soft-success" onClick="editCategoryList('+ row.id + ')">Edit</a>\
                    </li>\
                    <li>\
                        <a href="#removeItemModal" data-bs-toggle="modal" class="badge badge-soft-danger" onClick="removeItem('+ row.id + ')">Delete</a>\
                    </li>\
                </ul>');
                })
            },
