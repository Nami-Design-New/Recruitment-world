      ...
      s = setInterval(function() {
        ...
        o &&
          (o.innerHTML =
            ...
            d +
            "</div></div>"), t < 0 && (clearInterval(s), (o.innerHTML = '<div class="countdown-endtxt">The countdown has ended!</div>'));
      }, 1e3);
  });
});
...
function moveToNext(e, t) {
  ...
  1 === getInputElement(e).value.length &&
    (4 !== e
      ...
      : (getInputElement(e).blur(), console.log("submit code"))), 8 === t &&
    1 !== e &&
    getInputElement(e - 1).focus();
}
//--------------------animate counting-----------------------//
...
window.onscroll = function() {
  if (this.scrollY >= document.querySelector(".statics").offsetTop - 400) {
    if (!started) {
